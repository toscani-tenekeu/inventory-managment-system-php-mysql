    ...
    if ($stmt->rowCount() > 0) {
        ...
        if (password_verify($mot_de_passe, $row['mot_de_passe'])) {
            ...
            if ($role === 'admin') {
                ...
                echo "<script>alert('Ceci est un compte administrateur, vous serez redirigé vers la vue correspondante !'); window.location.href = '../../../admin/T2L1/vue/dashboard.php';</script>";
