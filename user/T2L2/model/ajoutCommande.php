...
$_SESSION['message']['text'] = "Order successfully completed!";
$_SESSION['message']['type'] = "success";

} else {
    // Failure message in session
    $_SESSION['message']['text'] = "Unable to process this order :(";
    $_SESSION['message']['type'] = "danger";
}
} else {
    // Error message in session
    $_SESSION['message']['text'] = "An error occurred during this order!";
    $_SESSION['message']['type'] = "danger";
}
