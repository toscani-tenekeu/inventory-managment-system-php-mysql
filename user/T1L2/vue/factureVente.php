            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <ul class="custom-list">
                        <li><strong>Client Name</strong><?= $nom_client ?></li>
                        <li><strong>Client First Name</strong><?= $prenom_client ?></li>
                        <li><strong>Phone Number</strong><?= $telephone_client ?></li>
                        <li><strong>Client Address</strong><?= $adresse_client ?></li>
                    </ul>
                </div>
            </div>
        </div>
