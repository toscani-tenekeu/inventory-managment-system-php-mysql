...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($langue === 'francais' && $theme === 'toscani') {
        ...
        echo "<script>alert('Parameter applied successfully!'); window.location.href='../../T1L1/vue/dashboard.php';</script>";
        exit();

    } elseif ($langue === 'anglais' && $theme === 'lovely-indian') {

        echo "<script>alert('Parameter applied successfully!'); window.location.href='../../T2L2/vue/dashboard.php';</script>";
        exit();

    } elseif ($langue === 'francais' && $theme === 'lovely-indian') {

        echo "<script>alert('Parameter applied successfully!'); window.location.href='../../T2L1/vue/dashboard.php';</script>";
        exit();

    } elseif ($langue === 'anglais' && $theme === 'toscani') {

        echo "<script>alert('Parameter applied successfully!'); window.location.href='../vue/dashboard.php';</script>";
        exit();
    }
    ...
    ?>
    <script>
        alert('Failure applying changes, please try again!');
