    ...
    <div class="overview-boxes">
        <div class="box">
            ...
            <form action="<?= !empty ($_GET['id']) ? "../model/modifCategorie.php" : "../model/ajoutCategorie.php" ?>" method="post">
                ...
                <label for="description_categorie">Category Description</label>
                ...
                ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a onclick="confirmerSuppressionCat(<?= $value['id'] ?>)" style="color: #f55;" title="Delete category"><i class="bx bx-trash" style="font-size: 30px; color: #f00;"></i></a>
                                </td>
                            </tr>
                <?php
                        }
