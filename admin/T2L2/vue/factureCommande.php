...
<head>
    ...
    <meta charset="UTF-8">
    <title>Invoice Lovely Indian</title>
...
<body>
    ...
    <div class="container invoice">
        <div class="invoice-header">
            <h1>Invoice <small>Lovely Indian</small></h1>
        ...
        <div class="invoice-body">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">About Supplier</h3>
                </div>
                <div class="panel-body">
                    <ul class="custom-list">
                        <li><strong style="margin-right: 2%;">Supplier's Name:</strong><?= $nom_fournisseur ?></li>
                        <li><strong style="margin-right: 2%;">Supplier's First Name:</strong><?= $prenom_fournisseur ?></li>
                        <li><strong style="margin-right: 2%;">Phone Number:</strong><?= $telephone_fournisseur ?></li>
                        <li><strong style="margin-right: 2%;">Address:</strong><?= $adresse_fournisseur ?></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title">More about the Orders</h3>
            </div>
