...
// Connexion à la base de données avec PDO (utilisez le même code que dans inscription.php)
    ...
    if ($stmt->rowCount() > 0) {
        ...
        if (password_verify($mot_de_passe, $row['mot_de_passe'])) {
            ...
            if ($role === 'admin') {
                ...
                echo "<script>alert('Le compte auquel vous essayez de vous connecter est un compte standard !\\n Vous serez rediriger vers la vue des utilisateurs standard.'); window.location.href = '../../../user/T2L1/vue/dashboard.php'; </script>";
            } else {
