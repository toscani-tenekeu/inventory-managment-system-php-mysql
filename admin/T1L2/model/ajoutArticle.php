...
if (
    ...
    if ($req->rowCount() != 0) {
        $_SESSION['message']['text'] = "Article added successfully!";
        $_SESSION['message']['type'] = "success";
    } else {
        $_SESSION['message']['text'] = "An error occurred while adding the article :(";
        $_SESSION['message']['type'] = "danger";
    }
} else {
    $_SESSION['message']['text'] = "A required field is not filled in";
    $_SESSION['message']['type'] = "danger";
}
